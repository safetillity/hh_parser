# ПРИЛОЖЕНИЕ ДЛЯ ПАРСИНГА И АНАЛИЗА ВАКАНСИЙ ХХ РУ

Полнофункциональное веб-приложение для анализа вакансий с HeadHunter (hh.ru). Приложение позволяет пользователям искать вакансии, анализировать статистику зарплат и просматривать распределение навыков. Доступно как веб-приложение и как десктопное приложение на Electron для всех систем.
